...
export default function Sidebar({ collapsed, mobileOpen, onCloseMobile, activeItem = 'dashboard' }: SidebarProps) {
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-40 flex flex-col border-r border-[#fefefe] dark:border-[#0c1220] bg-card transition-all duration-theme md:static md:translate-x-0 md:flex-shrink-0
